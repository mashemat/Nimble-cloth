 ...
 */
typedef kaa_logging_data_collection_float_t    kaa_user_log_record_t;

# define KAA_LOGGING_DESERIALIZE(reader)  kaa_logging_data_collection_float_deserialize(reader)
